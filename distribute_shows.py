...
complete_dir = "/Users/tspgallagher/Projects/Python/TV Show Parser/complete"
torrents_dir = "/Users/tspgallagher/Projects/Python/TV Show Parser/Torrents"
tv_dowloads_root = "/Users/tspgallagher/Projects/Python/TV Show Parser/TVDownloads"
sep = "/"

path = Path(complete_dir)
# path = Path(torrents_dir)
...
for p in path.iterdir():
    if p.is_dir():
        ...
        for dep in dld_episode_dir.iterdir():
            if (dep.suffix == ".mkv"):
                src_name = str(dep)
                episode_name = dep.parts[-2]    # Throw away any obfuscation
                ...
                if not dst_directory.exists():
                    try:
                        ...
                        print("Unable to make destination directory" + dst_directory)
                        exit

                dst_name = str(dst_directory) + sep + episode_name + dep.suffix
                try:
